...
def wintersakura_upload(web,file1,record_path,qbinfo,basic,hashlist):
    ...
    try:
        ...
        if file1.Video_Format=='H264':
            ...
            select_codec_sel_ob.select_by_value('8')
        elif file1.Video_Format=='H265':
            select_codec_sel_ob.select_by_value('9')
        elif file1.Video_Format=='x265':
            select_codec_sel_ob.select_by_value('7')
        else:
            select_codec_sel_ob.select_by_value('6')
