...
setup(
    ...
    install_requires = ["loguru","pathlib","typing","pyyaml","requests","bs4","lxml","datetime","selenium","qbittorrent-api","undetected_chromedriver","function_controler","ddddocr","doubaninfo"]
)